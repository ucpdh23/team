"""Agregación de los datos de coste de los agentes (solo librería estándar).
...
Aquí solo se agrega; el grueso del dibujado (gráficas) ocurre en el navegador con Chart.js y
el servidor HTTP que expone esto vive en `server.py`.
"""
